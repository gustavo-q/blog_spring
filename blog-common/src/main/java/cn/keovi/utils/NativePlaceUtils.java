...
public class NativePlaceUtils {
    /**
     * 识别方法
     * @param nativePlaceCode 输入完整的身份证号
     * @return
     */
    public static String[] getNativePlace(String nativePlaceCode) {
        int nativePlaceCodes = Integer.parseInt(nativePlaceCode.substring(0, 6));
        int shengCode = nativePlaceCodes / 10000;
        int shiCode = nativePlaceCodes / 100;
        int quxianCode = nativePlaceCodes;
