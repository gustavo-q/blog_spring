...
public class PageHelper implements Interceptor {
    ...
    public static void startPage(Integer pageNum, Integer pageSize) {
        ...
        localPage.set(new Page(pageNum, pageSize, true));
    }
     ...
     * @param calTotal
     */
    public static void startPage(Integer pageNum, Integer pageSize, boolean calTotal) {
        if (pageNum == null) {
            pageNum = 1;
        }
        if (pageSize == null) {
        ...
        localPage.set(new Page(pageNum, pageSize, calTotal));
    }
...
//        pageSql.append(") where row_id > ").append(page.getStartRow());
    ...
    public static class Page<E> implements Serializable {
        ...
        public Page(Integer pageNum, Integer pageSize, boolean calTotal) {
            pageNum = pageNum == null ? 0 : pageNum;
            pageSize = pageSize == null ? 10 : pageSize;
            this.pageNum = pageNum;
            this.pageSize = pageSize;
     ...
     * @return
     */
    public static int getTotalPage(Integer total, Integer pageSize) {
