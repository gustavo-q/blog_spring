...
public class Minio {
     ...
     * minio参数
     */
    private static final String ENDPOINT = "http://180.163.101.78:9000";
    private static final String ACCESS_KEY = "qweasdzxcd";
    private static final String SECRET_KEY = "qazwsxedcad";
